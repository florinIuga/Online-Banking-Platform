...
const NavBarInstance = ({ onSelect, activeKey, ...props }) => {
    ...
    <Nav.Item eventKey="1" icon={<Icon icon="user" />} onClick={goToUsers}>Users</Nav.Item>
            <Nav.Item eventKey="2" icon={<Icon icon="bar-chart" />} onClick={goToGraphs}>Analytics</Nav.Item>
          </Nav>
          <Nav pullRight>

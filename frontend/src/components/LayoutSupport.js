...
const NavBarInstance = ({ onSelect, activeKey, ...props }) => {
    ...
    const goToDashboard = () => {
      history.push('/dashboard_support');
    }

    const goToForum = () => {
      history.push('/forum_support');
    }
      ...
      <Navbar {...props}>
        ...
        <Navbar.Body>
          <Nav onSelect={onSelect} activeKey={activeKey}>
            <Nav.Item eventKey="1" icon={<Icon icon="home" />} onClick={goToDashboard}>
              Home
            </Nav.Item>
            <Nav.Item eventKey="2" icon={<Icon icon="comments" />} onClick={goToForum}>Forum</Nav.Item>
          </Nav>
          <Nav pullRight>
